...
class RecipeSorterEngravingTable implements Comparator
{
final CraftingManagerEngravingTable CraftingManagerEngravingTable;

RecipeSorterEngravingTable(CraftingManagerEngravingTable par1CraftingManagerEngravingTable)
{
         this.CraftingManagerEngravingTable = par1CraftingManagerEngravingTable;
}
